...
ts175_train_fit_TRUE1 = tscount::tsglm(ts=ts175_train, link='log', model =
                                        list(past_obs = true_reg_lags1, past_mean = true_reg_lags1),distr = 'nbinom')
...
ts175_test_fit =  (ts175_test_fit1$pred + ts175_test_fit2$pred + ts175_test_fit3$pred + ts175_test_fit4$pred)/4
