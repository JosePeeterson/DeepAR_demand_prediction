...
class train_validate_n_test(object):
    ...
    def xgb_train_validate(self,params,num_round, e_s_r):
        dtrain1, dval1 = self.walk_forward_val_n_train_set(fold=1)
        watchlist1  = [(dtrain1,'train1_cross_entropy_loss'), (dval1, 'val1_cross_entropy_loss')]
        evals_result1 = {}
        ...
        val1_error = evals_result1['val1_cross_entropy_loss']['mlogloss']

        dtrain2, dval2 = self.walk_forward_val_n_train_set(fold=2)
        watchlist2  = [(dtrain2,'train2_cross_entropy_loss'), (dval2, 'val2_cross_entropy_loss')]
        evals_result2 = {}
        ...
        val2_error = evals_result2['val2_cross_entropy_loss']['mlogloss']

        dtrain3, dval3 = self.walk_forward_val_n_train_set(fold=3)
        watchlist3  = [(dtrain3,'train3_cross_entropy_loss'), (dval3, 'val3_cross_entropy_loss')]
        evals_result3 = {}
        ...
        val3_error = evals_result3['val3_cross_entropy_loss']['mlogloss']
    ...
    def make_predictions(self,best_params,num_round, e_s_r):
        ...
        watchlist4  = [(dtrain4,'train4_cross_entropy_loss')]
        evals_result4 = {}
...
def objective(trial):
    ...
    val_avg_error = t_v_t.xgb_train_validate(params,num_round, early_stopping_rounds)
    return val_avg_error
...
if __name__ == "__main__":
    ...
    best_params = {"max_depth": study.best_params["max_depth"],
            ...
            'eval_metric':'mlogloss', ## try using AUC as well.. 
