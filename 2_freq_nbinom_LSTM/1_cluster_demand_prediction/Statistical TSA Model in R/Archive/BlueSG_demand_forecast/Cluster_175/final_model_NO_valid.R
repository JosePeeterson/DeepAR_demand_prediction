...
tr_stop = (3*7*24 + tr_strt - 1) #(5 weeks, 7 days, 24 hours)  

val_strt = tr_stop - 7*24 + 1 # use only 1 day (same day as test) for validation from train
val_stop = tr_stop - 7*24 + 24
...
ts175_test_fit = predict( ts175_train_fit, n.ahead=test_hrs)
